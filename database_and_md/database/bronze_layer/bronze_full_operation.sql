...
=======================================================================================
to run the code properly you must run the entier code only once and if u want to load the 
tables agine you must run the next code: 
...
DECLARE @start_time DATETIME, @end_time DATETIME, @batch_start_time DATETIME, @batch_end_time DATETIME; 
	BEGIN TRY
		...
		PRINT '>> ------------------------';
			...
			IF OBJECT_ID ('bronze.places', 'U') IS NOT NULL
		...
		PRINT '>> -----------------------';
			...
			IF OBJECT_ID ('bronze.reviwes', 'U') IS NOT NULL 
		...
		PRINT '>> ---------------------------';
			...
			IF OBJECT_ID ('bronze.locals', 'U') IS NOT NULL 
		...
		PRINT '>> -----------------------';
			...
			IF OBJECT_ID ('bronze.media', 'U') IS NOT NULL 
